...
var Fullpage = (_temp$1 = _class$1 = function (_PureComponent) {
  ...
  function Fullpage(props) {
    ...
    _this.driver = React__default.createRef();
    ...
    value: function () {
      function render() {
        ...
        return React__default.createElement(
          'div',
          null,
          React__default.createElement('div', { style: { position: 'relative' }, ref: this.driver }),
          React__default.createElement(
            'div',
            ...
            React__default.createElement(
              ...
              this.children,
              navigation && React__default.createElement(FullpageNavigation, { data: children, previousSlide: previousSlide })
            )
          )
        );
      }
  ...
  this.getChildren = index(function (children) {
    return React__default.Children.map(children, function (child) {
      ...
      if (child && child.type === FullpageSection) {
        props.ref = React__default.createRef();
      }
